...
import MOCK_RESOURCES_HOME_DEPOT from "./MOCK_RESOURCES_HOME_DEPOT.json";
...
export const ResourcesTable = () => {
  ...
  const columns = useMemo(() => resourcesColumns, []);
  const data = useMemo(() => MOCK_RESOURCES_HOME_DEPOT, []);
